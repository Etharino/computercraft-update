...
local DEFAULT_PAGE_WIDTH = 25
local DEFAULT_PAGE_HEIGHT = 21
...
local function printLines(lines, title)
  local page = 1
  local y = 1
  local width = DEFAULT_PAGE_WIDTH
  local height = DEFAULT_PAGE_HEIGHT
...
local function printTypedText()
  ...
  local lines = makePrintableLines(text, DEFAULT_PAGE_WIDTH)
...
local function printTextFile()
  ...
  local lines = makePrintableLines(data, DEFAULT_PAGE_WIDTH)
...
local function printImageFile()
  ...
  local lines = loadImageAsAscii(path, DEFAULT_PAGE_WIDTH, DEFAULT_PAGE_HEIGHT)
...
local function showStatus()
  ...
  print("Page size: " .. DEFAULT_PAGE_WIDTH .. " x " .. DEFAULT_PAGE_HEIGHT)
end
